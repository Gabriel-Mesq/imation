        ...
        <section id="about" className="section about">
            <div className="container">
                ...
                <div className="about-content">
                    ...
                    <p>
                        Com anos de experiência no mercado, desenvolvemos ferramentas robustas e intuitivas, como nosso emissor de NFSe gratuito, que já ajuda milhares de empreendedores em todo o Brasil.
                    </p>
                </div>
            </div>
        </section>
